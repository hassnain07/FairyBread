...
export const supabaseDataClient: DataClient = {
  ...
  async getAllFamilies() { throw new Error('Supabase not implemented yet'); },
  ...
  async submitPayment() { throw new Error('Supabase not implemented yet'); },
  async uploadPaymentProof() { throw new Error('Supabase not implemented yet'); },
  async getPendingPayments() { throw new Error('Supabase not implemented yet'); },
  ...
  async createTeacherAssessment() { throw new Error('Supabase not implemented yet'); },
  async getConversations() { throw new Error('Supabase not implemented yet'); },
  async getMessages() { throw new Error('Supabase not implemented yet'); },
  async sendMessage() { throw new Error('Supabase not implemented yet'); },
  async markConversationRead() { throw new Error('Supabase not implemented yet'); },
